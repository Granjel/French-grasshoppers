...
library(nlme)
French_grasshoppers_dt <- read.table(file = "C:/Users/Granjel RR/Desktop/Nico Gross/French_grasshoppers_dt.txt", header = TRUE, sep = "\t") #change the directory if needed
```
...
```{r BROERE data}
#creating a dataframe removing the rows when d_BROERE is NA and changing all the NAs for zeroes
...
```{r ARRELA data}
#creating a dataframe removing the rows when d_ARRELA is NA and changing all the NAs for zeroes
